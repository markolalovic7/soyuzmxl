  ...
  <div className={classes["jersey"]}>
    <div className={classes["jersey__item"]}>
      <svg viewBox="0 0 312 312">
        <defs>
          <linearGradient id="40_linearGradient-1" x1="3.967%" x2="82.02%" y1="3.362%" y2="94.266%">
          ...
          <path
            ...
            id="40_path-2"
          />
          <filter filterUnits="objectBoundingBox" height="109.6%" id="40_filter-4" width="111.4%" x="-5.7%" y="-3%">
        ...
        <g data-base fill={baseColor} fillRule="evenodd">
          <mask fill="#fff" id="40_mask-3">
            <use xlinkHref="#40_path-2" />
          </mask>
          <use fill="#000" filter="url(#40_filter-4)" xlinkHref="#40_path-2" />
          <use fill="#000000" xlinkHref="#40_path-2" />
          <path
            ...
            strokeWidth="0.58"
          />
          <g data-stripes fill={splitColor} mask="url(#40_mask-3)">
            <g transform="translate(79.333 28.022)">
              <mask fill="#fff" id="40_mask-6">
                <use xlinkHref="#40_path-5" />
              </mask>
              <rect height="276.178" mask="url(#40_mask-6)" width="90.711" x="75.689" y="-8.667" />
            </g>
          </g>
          <path
            data-sleeve
          ...
          <path
            ...
            mask="url(#40_mask-3)"
          />
          <use fill="url(#40_linearGradient-1)" xlinkHref="#40_path-2" />
        </g>
        <text
          dx="0em"
          dy="0.4em"
...
VerticalSplitJersey.defaultProps = {
  jerseyNumberColor: "transparent",
};

export default VerticalSplitJersey;
