        ...
        <div className={classes["spoilers"]}>
          {!isEmpty(europeanDashboardLiveData) &&
            Object.entries(europeanDashboardLiveData).map((sportEntry) => {
              ...
              return (
                <div className={cx(classes["spoiler"], classes["active"])} key={sportCode}>
                  <div className={classes["spoiler__header"]}>
                    <div className={classes["spoiler__icon"]}>
                      <span className={classes[`qicon-${sportCode.toLowerCase()}`]} />
                    </div>
                    <div className={classes["spoiler__sport"]}>
...
export default React.memo(LiveCentralSection);
