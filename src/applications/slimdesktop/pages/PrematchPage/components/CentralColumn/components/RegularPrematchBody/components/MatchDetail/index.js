...
import HeaderOutcomePrice from "../../../CompactPrematchBody/RightCompactColumn/components/HeaderOutcomePrice";
import PrematchNavigationTabs from "../../../CompactPrematchBody/RightCompactColumn/components/PrematchNavigationTabs";
import RightMatchOutcome from "../../../CompactPrematchBody/RightCompactColumn/components/RightMatchOutcome";
...
const MatchDetail = () => {
  ...
  return (
    <div className={cx(classes["content__box-2"])}>
      {!match && (
        <div className={cx(classes["spinner-container"])}>
      ...
      {eventCouponData && match && (
        <>
          <div
            className={cx(classes["sport-head"], classes["sport-head--full"])}
            style={{ backgroundImage: `url(${getImg(match.code)})` }}
          >
            <div className={classes["sport-head__inner"]}>
              <div className={classes["sport-head__info"]}>
                <div className={cx(classes["title-1"], classes["title-1_special"])}>International: Premier League</div>
          ...
          <div className={classes["content-tabs"]}>
            ...
            <div className={classes["content-tabs__content"]}>
              ...
              <div className={classes["content-tab"]}>asd</div>
            </div>
          </div>
        </>
      )}
