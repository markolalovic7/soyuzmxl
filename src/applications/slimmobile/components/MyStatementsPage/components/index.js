...
const MyStatementsPage = () => {
  ...
  const renderTransactionItems = () => {
    ...
    if (transactionsFiltered.length === 0) {
      return (
        <div className={classes["my-statements-body-empty-container"]}>
          <div className={classes["my-statements-body-empty-text"]}>
            {t("slimmobile.pages.my_statements_page.my_statements_empty")}
          </div>
        </div>
      );
    }
