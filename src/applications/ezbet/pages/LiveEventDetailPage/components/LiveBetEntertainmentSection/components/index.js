...
const LiveBetEntertainmentSection = ({ eventId, feedcode, hasAVLive, hasData, hasMatchTracker }) => {
      ...
      <section className={classes["bet-entertainment-wrapper"]}>
        ...
        {!collapsed && (
          <>
            ...
            >
              {selectedButton === "MATCH_TRACKER" && <LiveMatchTracker feedcode={feedcode} hasData={hasData} />}
              {selectedButton === "TV" && <LiveVideo eventId={eventId} hasData={hasData} />}
            </section>
          </>
        )}
      </section>
