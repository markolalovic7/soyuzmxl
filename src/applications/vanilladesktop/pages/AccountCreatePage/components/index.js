import CheckboxField from "applications/vanilladesktop/components/FormFields/CheckboxField";
    ...
    <main className={classes["main"]}>
      <div className={classes["registration"]}>
        <div className={classes["registration__container"]}>
          <h3 className={classes["registration__label"]}>{t("create_account")}</h3>
            ...
            <form action="#" className={cx(classes["registration__form"], classes["form"])} onSubmit={handleSubmit}>
              <div className={classes["registration__items"]}>
                ...
                <div className={classes["registration__item"]}>
                  ...
                  <div className={classes["registration__checkboxes"]}>
                    <CheckboxField
                      required
