import ToolbarDropdown from "applications/vanilladesktop/pages/MyBetsPage/components/MyBetsTable/components/ToolbarDropdown";
...
const TableToolbar = ({ dateEnd, dateStart, setDateEnd, setDateStart, setTabActive, tabActive, toggleRefresh }) => {
    ...
    <h3 className={classes["registration__label"]}>
      ...
      <div className={classes["filters"]}>
        <div className={classes["filter"]}>
          <ToolbarDropdown setTabActive={setTabActive} tabActive={tabActive} />
        </div>
