...
const propTypes = {
  ...
  onSameSelections: PropTypes.func.isRequired,
};

const BetslipSuccessPopup = ({ isOpen, onClearSelections, onSameSelections }) => {
        ...
        <div className={classes["betslip-popup__content"]}>
          ...
          <div className={classes["betslip-popup__message"]}>
            ...
            <div className={classes["betslip-popup__buttons"]}>
              <div className={classes["betslip-popup__button"]} onClick={onSameSelections}>
                {t("betslip_panel.previous_selections")}
              </div>
              <div
                className={cx(classes["betslip-popup__button"], classes["betslip-popup-closer2"])}
...
BetslipSuccessPopup.propTypes = propTypes;

export default BetslipSuccessPopup;
