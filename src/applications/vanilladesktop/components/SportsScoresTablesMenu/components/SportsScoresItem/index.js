...
const SportsScoresItem = ({ activeEventId, autoExpanded, counter, icon, label, matches, onSelectMatch }) => {
          ...
          >
            {Object.entries(groupHash).map((entry) => {
              ...
              return matches.map((match, index) => {
                ...
                return (
                  <SportsScoresTable
                    active={activeEventId === match.eventId}
                    cMin={match.cMin}
...
SportsScoresItem.defaultProps = defaultProps;
