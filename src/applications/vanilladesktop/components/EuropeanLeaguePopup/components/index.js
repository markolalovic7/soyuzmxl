...
const EuropeanLeaguePopup = ({ code, excludedTournaments, isOpen, onClose, setExcludedTournaments }) => {
...
EuropeanLeaguePopup.propTypes = propTypes;

export default React.memo(EuropeanLeaguePopup);
