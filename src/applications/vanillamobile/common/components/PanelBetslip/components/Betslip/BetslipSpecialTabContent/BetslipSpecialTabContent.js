...
import { getCmsConfigBettingSpecialStakeLimits } from "../../../../../../../../redux/reselect/cms-selector";
import {
  claimFreeBet,
...
const BetslipSpecialTabContent = ({ stakeChangeConfirmedHandler, stakeChangeHandler, stakeChangeState }) => {
            ...
            <div className={classes["betslip__card-container"]}>
              <div className={classes["betslip__card-head"]}>
                <span className={classes["betslip__card-title"]}>
                  {`${multiple.typeDescription} (${multiple.numSubBets})`}
                </span>
              ...
              <div className={classes["betslip__card-body"]}>
                ...
                {stake > 0 && stake < specialStakeLimits[currencyCode]?.min && (
                  <div className={classes["betslip__card-stake"]}>
                    <span />
                ...
                {stake > specialStakeLimits[currencyCode]?.max && (
                  <div className={classes["betslip__card-stake"]}>
                    <span />
                    <span style={{ color: "red" }}>
                ...
                <div className={classes["betslip__card-returns"]} style={{ marginBottom: "3px" }}>
                  <span>{t("betslip_panel.total_stake")}</span>
                  <span>
                    {dirtyPotentialWin
                      ? ""
                      : `${getSymbolFromCurrency(currencyCode)} ${multiple.stake.toLocaleString(undefined, {
                ...
                <div className={classes["betslip__card-returns"]}>
                  ...
                  <span>
                    {dirtyPotentialWin
                      ? ""
                      : `${getSymbolFromCurrency(currencyCode)} ${getMultipleBetPotentialWin(
                          betslipData,
                          multiple.typeId,
...
BetslipSpecialTabContent.propTypes = {
...
export default React.memo(BetslipSpecialTabContent);
