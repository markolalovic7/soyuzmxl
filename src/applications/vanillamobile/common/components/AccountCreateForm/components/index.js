      ...
      <form onSubmit={handleSubmit}>
        ...
        {isDefined(fields[ACCOUNT_FIELD_LAST_NAME]) && (
            <ItemInput
                ...
                textError={
                    touched[ACCOUNT_FIELD_LAST_NAME] && (errors[ACCOUNT_FIELD_LAST_NAME] || apiErrors[ACCOUNT_FIELD_LAST_NAME])
                }
                ...
                onSetFieldValue={(name, value) => {
                  ...
                  setFieldValue(
                      ...
                      `${PHONE_NUMBER_COUNTRY_CODES[value]}${
                          values[ACCOUNT_FIELD_MOBILE].split(PHONE_NUMBER_COUNTRY_CODES[values[ACCOUNT_FIELD_COUNTRY_CODE]])[1] ??
                          ""
                      }`,
                  );
                }}
        ...
        {isDefined(fields[ACCOUNT_FIELD_MOBILE]) && (
            <ItemInput
                ...
                textError={touched[ACCOUNT_FIELD_MOBILE] && (errors[ACCOUNT_FIELD_MOBILE] || apiErrors[ACCOUNT_FIELD_MOBILE])}
                type="tel"
        ...
        <SectionHeader label={t("forms.account_details")} />
        ...
        {isDefined(fields[ACCOUNT_FIELD_EMAIL]) && (
            <ItemInput
                ...
                textError={touched[ACCOUNT_FIELD_EMAIL] && (errors[ACCOUNT_FIELD_EMAIL] || apiErrors[ACCOUNT_FIELD_EMAIL])}
