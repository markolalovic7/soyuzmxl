...
const SectionLeagueRecommendationLink = ({ description, eventPathId, onClose, sportCode }) => {
...
SectionLeagueRecommendationLink.propTypes = propTypes;

export default memo(SectionLeagueRecommendationLink);
