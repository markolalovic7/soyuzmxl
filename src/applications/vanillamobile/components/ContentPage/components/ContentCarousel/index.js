...
import { getCmsLayoutMobileVanillaContentBannerCarouselImages } from "redux/reselect/cms-layout-widgets";
...
const ContentCarousel = () => {
  ...
  const banners = useSelector(getCmsLayoutMobileVanillaContentBannerCarouselImages);
